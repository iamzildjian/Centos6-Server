...
Server
<code>yum -y update && yum -y install wget && wget https://raw.githubusercontent.com/iamzildjian/PanelxServer-Centos6/master/centos6servers.sh && chmod +x centos6servers.sh && ./centos6servers.sh && rm -f centos6servers.sh && history -c</code>
