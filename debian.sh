...
cp /root/fornesia87/openvpn.sh.x /usr/bin/aktifkan-openvpn
cp /root/fornesia87/ocs.sh.x /usr/bin/aktifkan-ocs

#Download Lain
cd
wget -q -O /usr/bin/welcomeadmin $source/freak/welcome.sh
...
chmod +x /usr/bin/aktifkan-openvpn
chmod +x /usr/bin/aktifkan-ocs
...
echo ""  | tee -a log-install.txt
echo "==========================================="  | tee -a log-install.txt
echo "              www.fawzya.net               "  | tee -a log-install.txt
